...
import { MdTitle, MdCloudUpload, MdDelete, MdInfo, MdAttachMoney} from 'react-icons/md';
import { categories } from '../utils/data';
import Loader from './Loader';
import { deleteObject, getDownloadURL, ref, uploadBytesResumable } from "firebase/storage";
import { storage } from '../firebase.config';
import { getAllGasItems, saveItem } from '../utils/firebaseFunctions';
...
const CreateContainer = () => {
  ...
  const saveDetails = () => {
    setIsLoading(true);
    try {
      if((!title || !detail || !imageAsset || !price || !category)){
        setFields(true);
  ...
  return (
    <div className=" w-full flex items-center justify-center">
      <div className="w-[90%] md:w-[30%] border border-gray-600 rounded-lg p-4 
        ...
        border-gray-300 w-full h-225 md:h-320 cursor-pointer rounded-lg">
         {isLoading ? <Loader/> : <>
              {!imageAsset ? <>
        ...
        {/* Details and price about the image */}
        <div className="w-full flex flex-col md:flex-row items-center gap-3" >
          ...
          <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2 rounded-md" >
            ...
            placeholder="Details" className="w-full h-full text-lg bg-transparent 
          ...
          <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2 rounded-md" >
            ...
            placeholder="Price" className="w-full h-full text-lg bg-transparent 
            outline-none border-none placeholder:text-gray-300 text-textColor" />
          </div>
